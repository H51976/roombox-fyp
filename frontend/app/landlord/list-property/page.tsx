    ...
    try {
      ...
      if (response.ok && data.success) {
        toast.success("Property listed successfully!", {
          description: "Your property has been added to RoomBox.",
        });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Add your property to RoomBox and start connecting with tenants</p>
        </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                >
